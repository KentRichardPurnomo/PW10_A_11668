...
function Materi1() {
  ...
  const textChangeHandler = (event) => {
    setMessage(event.target.value.trim().length < 3 ? 'Invalid' : 'Valid');
  };
  ...
  return (
    <div className="materi-container">
      <div className="materi-header">
        ...
        <p className="materi-subtitle">Cara mengelola status dalam komponen React</p>
      </div>
      ...
      <div className="input-section" style={{ '--index': 1 }}>
        <div className="input-group">
          <label className="input-label">
            <MessageCircle size={18} /> Validasi Pesan
          </label>
          <input
            type="text"
        ...
        <div className={`status-message ${message === 'Valid' ? 'status-valid' : 'status-invalid'}`}>
      ...
      <div className="input-section" style={{ '--index': 2 }}>
        <div className="input-group">
          <label className="input-label">
            <Send size={18} /> Ketik sesuatu maka akan tampil di bawah secara real-time
          </label>
          <input
            type="text"
            className="custom-input"
      ...
      {/* Input Ketiga - Submit Control */}
      <div className="input-section" style={{ '--index': 3 }}>
        <div className="input-group">
          <label className="input-label">
            <Lock size={18} /> Submit Control
          </label>
          <input
            type="text"
            className="custom-input"
